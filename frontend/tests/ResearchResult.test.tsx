...
const candidates = [
  {book_id: "book-1", title: "일의 철학", author: "unknown", score: 0.91, chunk_count: 4, retrieval_score: 0.7, perspective: "커리어 철학", inclusion_reason: "번아웃의 구조를 설명한다."},
  {book_id: "book-2", title: "행복한 이기주의자", author: "웨인 다이어", score: 0.84, chunk_count: 3, retrieval_score: 0.6, perspective: "자기 가치", inclusion_reason: "성과와 자아를 분리한다."},
...
const selection = {
  selected_books: [{book_id: "book-1", role: "문제 구조 설명", selection_reason: "번아웃 근거가 명확하다."}, {book_id: "book-2", role: "자기 가치 회복", selection_reason: "성과와 자아를 분리한다."}],
  excluded_books: [{book_id: "book-3", reason: "역할 중복"}],
  cross_book_connection: "번아웃의 구조에서 자기 가치 회복으로 이어진다.",
};
...
describe("ResearchResult", () => {
  it("shows transparent candidate reasons and supports local selection", async () => {
    ...
    expect(screen.getByText("번아웃의 구조를 설명한다.")).toBeInTheDocument();
