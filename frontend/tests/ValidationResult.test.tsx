...
describe("ValidationResult", () => {
  it("shows issue severity, source lines, and report downloads", async () => {
    ...
    render(<ValidationResult artifacts={{runId: "run_1", report: "# report", result: {
      ...
      citations: [{citation_id: "c1", paragraph_id: "p2", section_id: "s2", text_type: "quotation", text: "변경된 인용", book_ids: ["b1"], evidence_ids: ["e1"], status: "invalid", confidence: .42, review_summary: "원문 불일치", sources: [{chunk_id: "ch1", book_id: "b1", title: "행복론", author: "저자", source_file: "철학/행복론.md", heading_path: ["2장", "행복과 삶"], start_line: 21, end_line: 23, content_hash: "hash"}]}],
    }}} />);
