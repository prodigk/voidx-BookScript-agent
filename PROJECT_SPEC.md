...
예를 들어 직장인 타겟은 심리적 위로와 공감으로 시작한 뒤 생산성과 동기부여로 확장할 수 있어야 한다. 생산성·조직관리 문맥을 모든 주제에서 일괄 제외하지 않고 타겟과 영상 흐름에 따라 포함, 제외 또는 후반부 확장 역할로 지정한다.
