...
- Phase 8: FastAPI 작업 API와 Next.js 주제 입력·후보 선택·구성안 편집·대본·검증·선택 문단 리비전 UI
- 한 권 쇼츠: 60초·1권 연구, 4단 구성안, 책 소개 대본과 기존 검증 흐름
...
- 작업 취소·일반 작업 자동 재시도와 새로고침 후 작업 공간 복원은 아직 없다.
- 자동 부분 재작성은 근거 범위 대체문이 있는 요약·인과관계 이슈만 지원하며 출처·행·인용·귀속 오류는 수동 확인이 필요하다.
- Remotion은 별도 후속 작업으로 유지하며 문장 단위 자막과 외부 영상 자산은 아직 연결하지 않았다.
- 쇼츠는 시나리오와 출처 연결 대본까지 지원하며 실제 음성 기준 길이 측정과 9:16 Remotion 렌더링은 아직 연결하지 않았다.
